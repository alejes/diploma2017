...
public class DynamicOverloadResolution {
    private static final String DEFAULT_CALLER_SUFFIX = "$default";
    @NotNull
    ...
    @Nullable
    public static MethodHandle resolveMethod(MethodHandles.Lookup caller, @NotNull String name, @NotNull Object[] arguments, @Nullable String[] namedArguments, boolean isStaticCall) {
